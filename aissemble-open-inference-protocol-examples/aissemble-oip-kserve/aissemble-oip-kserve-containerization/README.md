...
* This Example Consists of 2 Modules:
  * `aissemble-oip-kserve-containerization-deploy`
    ...
    * Kserve can specify arguments to configure any deployment options. More information on Configuration option for inference service can be found [here](https://kserve.github.io/archive/0.15/modelserving/v1beta1/custom/custom_model/#deploy-the-rest-custom-serving-runtime-on-kserve).
