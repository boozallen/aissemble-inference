...
The `content_type` parameter lets you declare, at either request time or in model metadata, how each OIP-compliant input should be converted into a Python object.
