...
This example demonstrates how to use the `aissemble-inference-sumy` module for text summarization with MLServer and the OIP Client.

## What This Example Demonstrates

- Integration between aissemble-inference-core, aissemble-inference-sumy, and MLServer
...
- aissemble-inference-core and aissemble-inference-sumy modules
...
### SumyRuntime
The MLServer runtime provided by `aissemble-inference-sumy`. Supports:
...
### HttpOipAdapter
HTTP client from `aissemble-inference-core` that communicates with MLServer:
...
- Verify aissemble-inference-sumy is installed: `uv pip show aissemble-inference-sumy`
