...
from aissemble_oip_yolo import YOLORuntime, YOLOTranslator


@given("the aissemble-oip-yolo package is installed")
def step_package_installed(context):
    """Verify the package is importable (which means it's installed)."""
    import aissemble_oip_yolo

    context.package = aissemble_oip_yolo
