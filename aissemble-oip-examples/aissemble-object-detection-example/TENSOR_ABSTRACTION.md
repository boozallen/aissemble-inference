...
```python
from aissemble_oip_core.client import InferenceClient
from aissemble_oip_core.client.translators import DefaultObjectDetectionTranslator
...
```python
from aissemble_oip_core.client import InferenceClient
from aissemble_oip_core.client.translators import TensorFlowObjectDetectionTranslator
...
from aissemble_oip_core.client.results import ObjectDetectionResult
