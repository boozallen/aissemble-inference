...
class RawInferenceBuilder:
    ...
    def inputs(self, tensors: Dict[str, Any]) -> None:
        ...
        tensors : dict[str, Any]
            A mapping of input names to tensor objects (or compatible representations such as NumPy arrays,
        ...
        -------
        None
            This method intentionally does not support fluent chaining.
        """
    ...
    def parameters(self, parameters: Dict[str, Any]) -> None:
        ...
        parameters : dict[str, Any]
            A mapping of parameter names to their values.  Meaning and supported keys are model-specific.
    ...
    def run(self) -> Dict[str, Any]:
        ...
        ------
        RuntimeError
            If the request cannot be executed (e.g., missing client context, network error, etc.).
        NotImplementedError
            Placeholder until the actual execution logic is wired in by the library.
        """
